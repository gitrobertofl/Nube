...
public class MiRegistroRMI
   ...
   * 
   * @param dirIP una cadena con una IP valida
   * @param puerto un entero con el numero de puerto
   *
   **************************************************************************/
  public static void refAMiRegRMI(String dirIP,Integer puerto)
	...
	TRAZA.setLevel(Level.OFF);//ALL u OFF PARA ACTIVAR O DESACTIVAR	
...
//métodos registro servicios
 /******************************************************************************
   ...
   * 
   * @param bind cadena que identifica el objeto remoto.
   * @param servicio objetoRemoto es el objeto a registrar
   * 
 ...
 public static void registrarObjetoRemoto(String bind,Remote servicio)
   ...
   *  del host.
   *  
   *  @return devuelve un String con la dirección IP o vacia si hubo problema
   *
   ****************************************************************************/  
